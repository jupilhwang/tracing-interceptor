...
import static jj.monitor.TracingConfiguration.ENCODING_CONFIG;
import static jj.monitor.TracingConfiguration.ENCODING_DEFAULT;
import static jj.monitor.TracingConfiguration.HTTP_ENDPOINT_CONFIG;
import static jj.monitor.TracingConfiguration.HTTP_ENDPOINT_DEFAULT;
import static jj.monitor.TracingConfiguration.KAFKA_BOOTSTRAP_SERVERS_CONFIG;
import static jj.monitor.TracingConfiguration.LOCAL_SERVICE_NAME_CONFIG;
import static jj.monitor.TracingConfiguration.LOCAL_SERVICE_NAME_DEFAULT;
import static jj.monitor.TracingConfiguration.SAMPLER_RATE_CONFIG;
import static jj.monitor.TracingConfiguration.SAMPLER_RATE_DEFAULT;
import static jj.monitor.TracingConfiguration.SENDER_TYPE_CONFIG;
import static jj.monitor.TracingConfiguration.SENDER_TYPE_DEFAULT;
import static jj.monitor.TracingConfiguration.TRACE_ID_128BIT_ENABLED_CONFIG;
import static jj.monitor.TracingConfiguration.TRACE_ID_128BIT_ENABLED_DEFAULT;
...
class TracingBuilder {
  ...
  TracingBuilder(TracingConfiguration configuration) {
    ...
    this.localServiceName = configuration.getStringOrDefault(LOCAL_SERVICE_NAME_CONFIG, LOCAL_SERVICE_NAME_DEFAULT);
    String traceIdEnabledValue = configuration.getStringOrDefault(TRACE_ID_128BIT_ENABLED_CONFIG, TRACE_ID_128BIT_ENABLED_DEFAULT);
  ...
  static class SenderBuilder {
    ...
    SenderBuilder(TracingConfiguration configuration) {
      String senderTypeValue = configuration.getStringOrDefault(SENDER_TYPE_CONFIG, SENDER_TYPE_DEFAULT);
  ...
  public static class KafkaSenderBuilder {
    ...
    KafkaSenderBuilder(TracingConfiguration configuration) {
      this.bootstrapServers = configuration.getStringOrDefault(
          ...
          configuration.getStringOrDefault(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, configuration.getStringList(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG)));
  ...
  static class SamplerBuilder {
    ...
    SamplerBuilder(TracingConfiguration configuration) {
      String rateValue = configuration.getStringOrDefault(SAMPLER_RATE_CONFIG, SAMPLER_RATE_DEFAULT);
