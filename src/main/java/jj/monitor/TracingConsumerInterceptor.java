...
import static jj.monitor.TracingConfiguration.REMOTE_SERVICE_NAME_CONFIG;
import static jj.monitor.TracingConfiguration.REMOTE_SERVICE_NAME_DEFAULT;
...
public class TracingConsumerInterceptor<K, V> implements ConsumerInterceptor<K, V> {
  static final String SPAN_CONSUME_NAME = "consume";
  static final String SPAN_COMMIT_NAME = "commit";
